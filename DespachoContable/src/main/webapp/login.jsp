...
<html>
    ...
    <title>Login - Despacho Contable </title>
                    ...
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-block bg-login-image">
                                <<img src="https://pbs.twimg.com/media/Eou4bW2WEAEtDZZ?format=jpg&name=large" alt="alt"/>
                            </div>
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user" action="SvLogin" method="POST">
                                        ...
                                        <div class="form-group">
                                            <div class="custom-control custom-checkbox small">
                                                ...
                                                <label class="custom-control-label" for="customCheck">Recuerdarme
                                                    </label>
                                            </div>
                                        </div>
